...
function(a) {
	...
	a.laydate = function(b) {
		...
		+ c.viewtb + '<div class="laydate_bottom">' + '<ul id="laydate_hms">' + 
		'<li class="laydate_sj">时间</li>' + "<li><input readonly>:</li>" + 
		...
		'<a id="laydate_ok">确认</a>' + "</div>" + 
		(b.isv ? '<a href="https://sentsin.com/layui/laydate/" class="laydate_v" target="_blank">laydate-v' + 
